    ...
    <div className="min-h-screen bg-slate-50 flex flex-col md:flex-row font-sans text-slate-800">
      ...
      <main className="flex-1 bg-slate-50 relative min-w-0">
        <div className="max-w-6xl mx-auto p-4 md:p-8">
          <div className={activeTab === 'STATIC_PAGE' ? 'block' : 'hidden'}>
            <ArticleGenerator mode="STATIC_PAGE" />
          </div>
          <div className={activeTab === 'SINGLE_POST' ? 'block' : 'hidden'}>
            <ArticleGenerator mode="SINGLE_POST" />
          </div>
          <div className={activeTab === 'SEO_OPTIMIZER' ? 'block' : 'hidden'}>
            <SeoOptimizer />
          </div>
          <div className={activeTab === 'SEO_TITLE' ? 'block' : 'hidden'}>
            <SeoTitleGenerator />
          </div>
        </div>
      </main>
